...
*   **Create Mod support** — edit and build Create's processing recipes (mixing, crushing, pressing, and more), including output chances and heat requirements, wherever Create is available.
